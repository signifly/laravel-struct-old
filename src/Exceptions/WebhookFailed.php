...
class WebhookFailed extends Exception
{
    ...
    public static function missingEventKey()
    {
        return new static('The webhook call did not contain an event key. Valid webhook calls should always contain an event key.');
    }
